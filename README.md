...
- [Bitfield Consulting](https://bitfieldconsulting.com/posts)
- [Dave Cheney](https://dave.cheney.net/)
- [Internals for Interns](https://internals-for-interns.com/)
- [Murat Demirci](https://muratdemirci.com.tr/en/)
- [Victoria Metrics](https://victoriametrics.com/blog/categories/go-@-victoriametrics/)
- [Pavel Sanikovich](https://dev.to/devflex-pro)
- [Gabor Koos](https://blog.gaborkoos.com/categories/)
- [Ozan Sazak](https://sazak.io/articles)
- [Ardan Labs](https://www.ardanlabs.com/blog/)
- [Melatoni](https://nghiant3223.github.io/)
- [Damiano Petrungaro](https://www.damianopetrungaro.com/)
- [Mohamed Said](https://themsaid.com/)
- [Phil Pearl](https://philpearl.github.io/)
...
- [Data Races vs Race Conditions](https://cronokirby.github.io/posts/data-races-vs-race-conditions)
- [Learning Go's Concurrency Through Illustrations](https://medium.com/@trevor4e/learning-gos-concurrency-through-illustrations-8c4aff603b3)
- [Concurrency In Go Book](https://edu.anarcho-copy.org/Programming%20Languages/Go/Concurrency%20in%20Go.pdf)
- [Taming Goroutines - Efficient Concurrency with a Worker Pool in Go](https://blog.gaborkoos.com/posts/2025-08-08-Taming-Goroutines/)
- [Go Channels: A Runtime Internals Deep Dive](https://blog.gaborkoos.com/posts/2025-08-26-Go-Channels-A-Runtime-Internals-Deep-Dive/)
- [Channels vs Mutexes In Go - the Big Showdown](https://blog.gaborkoos.com/posts/2025-08-19-Channels-vs-Mutextes-the-Big-Showdown/)
...
- [Scheduler & Infinite Loops in Go](https://ashwingopalsamy.substack.com/p/go-scheduler-and-infinite-loops-in)
- [(Golang Triad)-I-Understanding the Golang Goroutine Scheduler GPM Model](https://dev.to/aceld/understanding-the-golang-goroutine-scheduler-gpm-model-4l1g)
- [Understanding the Go Scheduler: The GMP Model Explained](https://medium.com/@sharmasarvesh826/understanding-the-go-scheduler-the-gmp-model-explained-dee532c15c5f)
...
- [How Go (Golang) Works — A Deep Dive into Runtime Internals](https://muratdemirci.com.tr/en/go-runtime-internals/)
- [Understanding the Go Runtime](https://internals-for-interns.com/series/understanding-the-go-runtime/)
...
- [A Deep Dive Into Heap Allocations](https://cristiancurteanu.com/why-your-go-code-is-slower-than-it-should-be-a-deep-dive-into-heap-allocations/)
- [Go Memory Allocation — A Deep Dive](https://medium.com/@harsh.vishnoi01/go-memory-allocation-a-deep-dive-made-simple-faa2ffaf6a65)
...
- [(Golang Triad)-II-Go's Hybrid Write Barrier Garbage Collection](https://dev.to/aceld/golang-triad-ii-comprehensive-analysis-of-gos-hybrid-write-barrier-garbage-collection-3knh)
- [Garbage Collection in Go: From Reference Counting to Tri-Color to Green Tea](https://blog.gaborkoos.com/posts/2025-09-12-Garbage-Collection-In-Go.md/)
- [The Green Tea Garbage Collector Go Official Blog](https://go.dev/blog/greenteagc)
- [Green Tea GC: How Go Stopped Wasting 35% of Your CPU Cycles](https://peerlist.io/siddhartha/articles/green-tea-gc-how-go-just-cut-memory-waste-by-50)
...
- [Arrays, Slices, and Maps in Go](https://www.freecodecamp.org/news/arrays-slices-and-maps-in-go-a-quick-guide-to-collection-types/)
- [Visual Guide to Slices in Go](https://sazak.io/articles/visual-guide-to-slices-in-go-2024-03-25)
- [Slice Internals in Go: How the Runtime Expands Slices Efficiently](https://themsaid.com/slice-internals-in-go)
- [Go Slices: usage and internals](https://go.dev/blog/slices-intro)
- [Visual Guide to Go Maps: Hash Tables](https://sazak.io/articles/visual-guide-to-go-maps-hash-tables-2025-10-26)
...
- [Go Map Internals and Concurrent Safety](https://themsaid.com/golang-map-internals-concurrent-safety)
- [Go Maps looked sorted, but they weren't. They never can!](https://ashwingopalsamy.substack.com/p/go-maps-looked-sorted-but-they-werent?utm_source=profile&utm_medium=reader2)
...
- [Go Interfaces - Beyond the Basics](https://blog.gaborkoos.com/posts/2025-08-13-Go-Interfaces-Beyond-the-Basics/)
- [Go Interfaces - Composition Over Inheritance (And Common Sense)](https://blog.gaborkoos.com/posts/2025-08-10-Go-Interfaces-Composition-Over-Inheritance-And-Common_Sense/)
...
- [Runes, Bytes and Graphemes in Go](https://ashwingopalsamy.substack.com/p/runes-in-go?utm_source=profile&utm_medium=reader2)
- [Go's Constants: Beyond Basics](https://ashwingopalsamy.substack.com/p/gos-constants-beyond-basics?utm_source=profile&utm_medium=reader2)
- [Golang Defer: From Basic To Traps](https://victoriametrics.com/blog/defer-in-go/)
- [Peeking into Go struct tags](https://rednafi.com/go/struct-tags/)
...
- [Networking for Web Developers—How the Internet Works](https://themsaid.com/networking-for-web-developers-how-the-internet-works)
...
- [Filesystems series by Jesus Espino](https://internals-for-interns.com/series/filesystems/)
...
- [Building an IP Address Manager in Go](https://themsaid.com/building-an-ip-address-manager-in-go)
- [Building a Dependency Injection Container for Go](https://themsaid.com/building-a-dependency-injection-container-for-go)
- [gls: File Manager on Terminal with Go](https://sazak.io/articles/gls-file-manager-on-terminal-with-go-2022-07-19)
